...
class ServicoRequest {
  ...
  ServicoRequest(
      {this.idCliente, this.idTecnico, required this.equipamento, required this.marca, required this.filial, this.dataAtendimento, this.horarioPrevisto, required this.descricao});
