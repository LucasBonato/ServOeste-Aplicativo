      ...
      pw.TableRow(
        children: [
          pw.Padding(
            padding: const pw.EdgeInsets.all(8),
            child: pw.Text(
              'Início garantia: ${servico.dataInicioGarantia != null ? Formatters.applyDateMask(servico.dataInicioGarantia!) : '  /  /  '}',
            ),
          ),
          pw.Padding(
            padding: const pw.EdgeInsets.all(8),
            child: pw.Text(
              'Fim garantia: ${servico.dataFimGarantia != null ? Formatters.applyDateMask(servico.dataFimGarantia!) : '  /  /  '}',
            ),
          ),
        ],
      ),
