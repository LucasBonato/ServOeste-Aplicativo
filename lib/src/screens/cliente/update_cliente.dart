      ...
      body: BlocBuilder<ClienteBloc, ClienteState>(
        ...
        buildWhen: (previousState, state) {
          if (state is ClienteSearchOneSuccessState) {
            ...
            _clienteUpdateForm.telefoneFixo.value = (state.cliente.telefoneFixo!.isEmpty ? "" : Formatters.applyTelefoneMask(state.cliente.telefoneFixo!));
            _clienteUpdateForm.telefoneCelular.value = (state.cliente.telefoneCelular!.isEmpty ? "" : Formatters.applyCelularMask(state.cliente.telefoneCelular!));
            ...
            String complemento = partes.length > 2 ? partes.sublist(2).join(',').trim() : '';
                            ...
                            child: Column(mainAxisSize: MainAxisSize.max, children: [
                              ...
                              BlocListener<ClienteBloc, ClienteState>(
                                ...
                                child: CustomTextFormField(
                                  ...
                                  validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.nomeESobrenome.name),
                                    ...
                                    return Column(
                                      children: [
                                        CustomTextFormField(
                                          ...
                                          hide: true,
                                          validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.telefones.name),
                                      ...
                                      children: [
                                        BlocListener<EnderecoBloc, EnderecoState>(
                                          ...
                                          child: CustomTextFormField(
                                            ...
                                            validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.cep.name),
                                        ...
                                        CustomSearchDropDownFormField(
                                          ...
                                          validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.municipio.name),
                              ...
                              CustomTextFormField(
                                ...
                                validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.bairro.name),
                              ...
                              BlocListener<EnderecoBloc, EnderecoState>(
                                ...
                                listener: (context, state) {
                                  if (state is EnderecoSuccessState) {
                                    ...
                                    _clienteUpdateForm.numero.value = state.numero;
                                    _clienteUpdateForm.complemento.value = state.complemento;
                                  }
                                },
                                child: Column(
                                  children: [
                                          ...
                                          return Column(
                                            ...
                                            children: [
                                              CustomTextFormField(
                                                ...
                                                hide: true,
                                                type: TextInputType.text,
                                                validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.rua.name),
                                              ...
                                              CustomTextFormField(
                                                ...
                                                validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.numero.name),
                                    ...
                                    CustomTextFormField(
                                      ...
                                      hide: false,
                                      type: TextInputType.text,
                                      validator: _clienteUpdateValidator.byField(_clienteUpdateForm, ErrorCodeKey.complemento.name),
                                      onChanged: _clienteUpdateForm.setComplemento,
                                    ),
                                  ],
                                ),
                              ),
                                      ...
                                      listener: (context, state) {
                                        if (state is ClienteUpdateSuccessState) {
                                          ...
                                          ScaffoldMessenger.of(context)
                                              .showSnackBar(SnackBar(content: Text('Cliente atualizado com sucesso! (Caso ele não esteja atualizado, recarregue a página)')));
